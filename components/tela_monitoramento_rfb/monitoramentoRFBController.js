angular.module("yara")
.controller("monitoramentoRFBController",function($scope, $http){
    $scope.$on('$viewContentLoaded', function(){

        
    Highcharts.chart('ChartsLiquidos', {
        chart: {
            type: 'column'
        },
        title: {
            text: 'Relação de Descarga de Líquidos'
        },
        subtitle: {
            text: 'Quantidade Por Hora'
        },
        xAxis: {
            type: 'category',
            labels: {
    ...
    Highcharts.chart('ChartsGranel', {
        chart: {
            type: 'column'
        },
        title: {
            text: 'Relação de Descarga a Granel'
        },
        subtitle: {
            text: 'Quantidade Por Hora'
        },
